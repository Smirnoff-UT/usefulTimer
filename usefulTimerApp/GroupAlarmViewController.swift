...
class GroupAlarmViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
...
//        layout.headerReferenceSize = CGSize(width: windowWidth, height: windowHeight / 100 * 12)
    ...
    func createToolBar() {
        ...
        myUIBarButtonToGroupAlarm.tintColor = UIColor.blueColor()
