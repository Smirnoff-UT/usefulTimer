...
//        layout.headerReferenceSize = CGSize(width: windowWidth, height: windowHeight / 100 * 12)
    ...
    func createNavigationBar(){
        ...
        navigationBar.setItems([UINavigationItem(title: "Timer")], animated: false)
        navigationBar.barTintColor = UIColor(red: 41.0/255.0, green: 92.0/255.0, blue: 209.0/255.0, alpha: 1.0)
